<template>
  <section id="footer" class="relative mb-90">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          ...
          <div class="col-span-1">
            ...
            <div class="mt-3 grid space-y-3">
              <p>
                <a
                  class="inline-flex gap-x-2 text-black hover:text-blue-900 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  href="#"
                  >Pricing</a
                >
              </p>
          ...
          <div class="col-span-1">
            ...
            <div class="mt-3 grid space-y-3">
              ...
              <p>
                ...
                >
                <span
                  class="inline ms-1 text-xs bg-blue-700 text-white py-1 px-2 rounded-lg"
                  >We're hiring</span
                >
              </p>
            </div>
          ...
          <div class="col-span-2">
            ...
            <form>
              ...
              >
                <div class="w-full">
                  ...
                  <input
                    ...
                    id="hero-input"
                    name="hero-input"
                    class="py-3 px-4 block w-full rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none border border-gray-200"
              ...
              <p class="mt-3 text-sm text-black">
                New T-shirt or big discounts. Never spam.
              </p>
            </form>
          </div>
          <!-- End Col -->
        ...
        >
          <div class="flex justify-between items-center">
            <p class="text-sm text-black">
              © 2024 MusCrop. All rights reserved.
            </p>
          </div>
          <!-- End Col -->
          ...
          <div>
            <a
              class="w-10 h-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-black hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600"
              href="#"
            >
              <svg
